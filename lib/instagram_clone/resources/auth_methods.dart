...
// import 'package:insta_project/instagram_clone/resources/storage_methods.dart';
//
// import '../model_/user_model_screen.dart';
//
//
// class AuthMethods {
...
import '../model_/user_model_screen.dart' as model;
  ...
  Future<String> signUpUser({
    ...
    try {
      if (email.isNotEmpty &&
        ...
        await _firestore
            .collection("users")
            .doc((snapshot.docs.length + 1).toString())
            .set(user.toJson());
